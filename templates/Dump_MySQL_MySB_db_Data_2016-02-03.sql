...
(16, 'CURL', '/usr/bin/composer', 'Composer', '1.0.0-alpha11', 'composer.phar', '', 'https://getcomposer.org/installer', 1),
(17, 'TARGZ', '/sources/nodejs', 'NodeJS', '0.12.9', 'node_v0.12.9.tar.gz', 'node_v0.12.7.tar.gz', 'https://nodejs.org/dist/v0.12.9/node-v0.12.9.tar.gz', 1),
...
(29, 'ZIP', '/sources/xmlrpc-c', 'XMLRPC', '1.42.0', 'xmlrpc-c_v1.42.0.zip', 'xmlrpc-c_v1.41.02.zip', 'https://github.com/toulousain79/MySB/raw/v3.3/files/xmlrpc-c_v1.42.0.zip', 1),
