...
INSERT INTO [repositories] ([id_repositories], [type], [dir], [name], [version], [file], [old_file], [url], [active]) VALUES (13, 'TARGZ', '/sources/plowshare', 'Plowshare4', 4, 'Plowshare4.tar.gz', null, 'https://github.com/toulousain79/MySB/blob/v2.1/files/Plowshare4.tar.gz?raw=true', 1);
