...
('ZIP', '<InstallDir>/web/apps/ru/plugins/filemanager', 'ruTorrent Plugin FileManager', '0.09', 0, 'filemanager_v0.09.zip', 'https://github.com/toulousain79/MySB/raw/v5.x/files/filemanager_v0.09.zip', 1, 0, ''),
('ZIP', '<InstallDir>/web/apps/ru/plugins/fileupload', 'ruTorrent Plugin FileUpload', '0.02', 0, 'fileupload_v0.02.zip', 'https://github.com/toulousain79/MySB/raw/v5.x/files/fileupload_v0.02.zip', 0, 0, ''),
('ZIP', '<InstallDir>/web/apps/ru/plugins/fileshare', 'ruTorrent Plugin FileShare', '1.0', 0, 'fileshare_v1.0.zip', 'https://github.com/toulousain79/MySB/raw/v5.x/files/fileshare_v0.03.zip', 1, 0, ''),
('ZIP', '<InstallDir>/web/apps/ru/plugins/mediastream', 'ruTorrent Plugin MediaStream', '0.01', 0, 'mediastream_v0.01.zip', 'https://github.com/toulousain79/MySB/raw/v5.x/files/mediastream_v0.01.zip', 1, 0, ''),
...
('CURL', '/usr/bin/composer', 'Composer', '1.6.2', 0, 'composer.phar', 'https://getcomposer.org/download/1.6.2/composer.phar', 1, 0, ''),
...
('TARGZ', '<InstallDir>/sources/minisign', 'Minisign', '0.7.18', 0, 'minisign_v0.7.18.tar.gz', 'https://github.com/jedisct1/minisign/tarball/master', 1, 0, ''),
...
('WBM', '<InstallDir>/files', 'OpenVPNadmin Webmin', '3.1', 0, 'openvpn_v3.1.wbm', 'http://www.openit.it/index.php/it/openvpnadmin/download?task=finish&cid=29&catid=7', 1, 0, ''),
('WBM', '<InstallDir>/files', 'Nginx Webmin Module', '0.10', 0, 'nginx_v0.10.wbm', 'https://www.justindhoffman.com/sites/justindhoffman.com/files/nginx-0.10.wbm_.gz', 1, 0, ''),
...
('ZIP', '<InstallDir>/web/apps/nc', 'NextCloud', '12.0.4', 0, 'nextcloud_v12.0.4.zip', 'https://download.nextcloud.com/server/releases/nextcloud-12.0.4.zip', 1, 0, ''),
...
('ZIP', '<InstallDir>/web/wolf', 'Wolf CMS', '0.8.3.1', 0, 'wolf_v0.8.3.1.zip', 'https://github.com/toulousain79/MySB/raw/v5.x/files/wolf_v0.8.3.1.zip', 1, 0, ''),
